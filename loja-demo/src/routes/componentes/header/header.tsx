    ...
    return(
        <header className="bg-blue-300">
            <div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease-out"
                ...
                <nav role="navigation" className="nav-menu w-nav-menu"><a href="/" className="bg-blue-300">
                    <div className="">Ini­cio</div>
                    <div className=""></div>
                ...
                <div className="relative dib"><p className="bg-red-600">oi</p><a href="javascript:cartData.open()" data-node-type="commerce-cart-open-link"
